...
const MAIN_SLIDE_ARROW_LEFT = document.querySelector('.MainVisual .left');
const MAIN_SLIDE_ARROW_RIGHT = document.querySelector('.MainVisual .right');
...
const SOLUTION_SLIDE = new Swiper('.solu_slide', {
    ...
    on: {
        init: function () {
            SOLUTION_SLIDE_NUM_TOTAL.innerHTML = `0${this.slides.length / 3}`;
        },
        slideChangeTransitionStart: function () {
            // console.log(this.realIndex, this.slides.length);
